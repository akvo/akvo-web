...
class AkvoHomepageWidget extends WP_Widget {
    ...
    <!--      <hr class="delicateSmall"> -->      
          <div>
            <figure>
                <div> <a href="<?php echo $instance['link'];?>" style="background-image: url(/wp-content/imgcompress/thumb.php/?zc=1&w=261&h=150&src=<?php echo $instance['background_image'];?>)" alt="<?php echo $instance['title'];?>"></a></div>
