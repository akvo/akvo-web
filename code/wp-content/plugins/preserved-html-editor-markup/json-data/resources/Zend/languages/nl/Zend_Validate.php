...
return array(
	...
	// Kwgl_Validate_UrlSlug
	"May only contain alpha-numeric words separated by dash" => "Mag alleen alfanumerieke woorden gescheiden door dash bevatten",

	//Kwgl_Validate_LaterDate
	"This date cannot be earlier than the previous date" => "Deze datum kan niet eerder zijn dan de vorige datum",
);