...
<div id="content" class="floats-in networkPage">
	...
	<nav class="anchorNav2 wrapper">
		<ul>
			<li  class="rss"><a href="../">&lsaquo; Go back</a></li>
			<li  class="rss"><a href="https://rsr.akvo.org/rss/all-updates/">RSS Link for All RSR Updates &rsaquo;</a></li>
		</ul>
	</nav>
		...
		<ul class="floats-in">
			...
			<li class="upInfo">
				<div class="authorTime floats-in">
					...
					<em class="">by</em><span class="userName"></span>
				</div>
	...
	<section class="wrapper">
		...
		<?php
			$shortcode = '[jsondata_feed slug="rsr-many-updates-1" format="json" limit="' . get_field('starting_number_of_updates') . '" offset="0" photo__gte="a"]';
			do_shortcode($shortcode);
		?>
		</ul>
		<h4 id="loadingCaption" class="backLined" style="display: none;"> 
			Fetching updates...<br/><img src="<?php bloginfo('template_directory'); ?>/images/loading.gif" title="" alt="" /> 
		</h4>
