...
<div id="content" class="floats-in annual-report">
	...
	<section class="videoStatement">
		...
		<div class="videoContainer">
			<div class="vimeoBlockedMessage"><?php the_field('ar_video_backup_message'); ?></div>
	...
	<section class="stories">
		...
		<ul class="bxslider">
			<?php if( have_rows('ar_stories_items') ): while( have_rows('ar_stories_items') ): the_row(); ?>
			<li><img src="<?php the_sub_field('ar_story_image_url'); ?>"></li>      
			<?php endwhile; endif; ?>
		</ul>
	</section>
	...
	<section class="financials">
		<div class="wrapper">
			...
			<div class="income tableContainer">
				<table>
					<tr><th class="header padBelow">Income in €000</th></tr>
					<tr><td>Income own fundraising</td></tr>
					<tr>
			...
			<div class="costs tableContainer">
				<table>
					<tr><th class="header padBelow">Costs in €000</th></tr>
					<tr>
	...
	<section class="wrapper reflections">
		...
		<ul class="threeColumns floatsIn">
			<?php if( have_rows('ar_reflections_items') ): while( have_rows('ar_reflections_items') ): the_row(); ?>
				<li><a href="<?php the_sub_field('ar_reflection_link'); ?>"><img src="<?php the_sub_field('ar_reflection_image_url'); ?>"></a></li>      
			<?php endwhile; endif; ?>
		</ul>
	</section>
