...
<li class="faqMenu"><a href="#" class="faqMenuHead">What type of content do you provide or encourage on Akvopedia?</a>
  <ul class="faqMenuList">
    <li><p>We center our focus around sustainable, affordable, and low-tech technologies that enable our users to learn about, build, finance or implement water and sanitation projects around the world. We do not show technologies for urban areas (e.g. centralised high-tech water systems), but rather help rural or urban fringe “slum” areas (e.g. rainwater harvesting tank system for a village) in the developing world. The process our users face of undertaking a WASH project takes a lot of planning and follow up, so we try to provide organisational methods or approaches, as well as more simple construction i.e. how-to pages for things like household pumps and simple water quality methods. We are not a knowledge institute or directly connected with academia… therefore we seek information that we can repackage in a generally easy to read, user-friendly way.
</p><p>
