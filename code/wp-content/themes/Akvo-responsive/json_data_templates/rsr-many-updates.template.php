 ...
 * JSON feed URL: http://rsr.akvo.org/api/v1/project_update_extra/?limit=60&photo__gte=a
 * Resulting shortcode: [jsondata_feed slug="rsr-many-updates" limit="60" photo__gte="a"]
