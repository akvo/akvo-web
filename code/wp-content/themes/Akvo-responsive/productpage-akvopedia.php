...
<div id="content" class="floats-in productPage withSubMenu akvopediaProdPag">
	<hgroup>
		...
		<h2><?php the_field('akvopedia_tagline'); ?></h2>
	</hgroup>
	<section class="productDescr wrapper" id="akvopediaDescr">
		<h3><?php the_field('akvopedia_descr_title'); ?></h3>
		<p class="fullWidthParag centerED"><?php the_field('akvopedia_descr_text'); ?></p>
	</section>
	...
	<section class="figure"> 
		<div class="figcaption"><?php the_field('akvopedia_figcaption'); ?></div>
		<img src="<?php the_field('product_akvopedia_img'); ?>" title="akvopediaImg" class="wrapper"/> 
	</section>
	<section class="" id="akvopediaInFour">
		<h1 class="">Six portals</h1>
		<div class="fullWidthParag centerED"><?php the_field('akvopedia_fourPortal_txt'); ?></div>
		<ul class="wrapper sixColumns floats-in pedia4points">
			<li class="pointOne floats-in"> 
				<a href="//akvopedia.org/wiki/Water_Portal"><h3> <span>01</span>
    ...
    <li class="pointTwo floats-in">
      <a href="//akvopedia.org/wiki/Sanitation_Portal"><h3> <span>02</span>
    ...
    <li class="pointThree floats-in">
     <a href="//akvopedia.org/wiki/Finance_Portal"><h3> <span>03</span>
    ...
    <li class="pointFour floats-in">
      <a href="//akvopedia.org/wiki/Sustainability_Portal"><h3> <span>04</span>
    ...
    <li class="pointFive floats-in">
      <a href="//akvopedia.org/wiki/Decision_%26_Assessment_Tools"><h3> <span>05</span>
    ...
    <li class="pointSix floats-in">
      <a href="//akvopedia.org/wiki/Food_%26_Nutrition_Security_Portal"><h3> <span>06</span>
