<?php
	...
	class AKVO{
		...
		function assets(){
			...
			wp_enqueue_script('akvo-jquery', get_template_directory_uri() . '/js/akvo-jquery.js', array('jquery'), '1.0.4', true );
			...
			wp_enqueue_style('akvo-style', get_template_directory_uri().'/css/main.css', false, '2.5.1' );
