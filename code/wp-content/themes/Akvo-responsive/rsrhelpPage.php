    ...
    <ul class="vertMargin">
        ...
        <ul class="faqMenuList">
          <li>
            ...
            <ol style="list-style-type:decimal; margin-left:20px;">
              <li> Go to <a href="http://www.akvo.org" style="display:inline;">www.akvo.org</a>, click login in the upper right corner. In the Akvo RSR box click RSR administrator login page. Login with your username and password. </li>
            <li> After you've been logged in, click Projects and your organisation's project listing will appear. Then click on the project number to go to the project you wish to edit. </li>
            <li> Edit the fields you wish to edit and save your changes by clicking Save at the bottom of the page.</li></ol>
      ...
      <li class="faqMenu"><a href="#" class="faqMenuHead">How can I put my project online?</a>
        <ul class="faqMenuList">
          ...
          <h4>The organisation administrator is the person within your
...
"http://akvo.org/criteria-roles-and-procedures-for-akvo-partners/" style="display:inline;">partner
            ...
            <p>The notes box is not public. It allows you to make notes to
              ...
              project.</p>
            <p>When the form is completed, the administrator can click Save at the bottom of the page. Then the Akvo
