...
<div id="content" class="floats-in teamPage withSubMenu">
...
-->   <div id="partnershipGroup">
      ...
      <ul class="staff floats-in">
        ...
        <li class="staffAsset partnership management" id="kathelyne">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/kathelyne240x135.png" title="Kathelyne van den Berg" alt="Kathelyne van den Berg, manager, partner operations" /></div>
        ...
        <li class="staffAsset partnership" id="markW">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/mtw1.jpg" title="Mark Tiele Westra" alt="Mark Tiele Westra, Akvopedia editor and programme manager " /></div>
        ...
        <li class="staffAsset partnership" id="jeroen">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/jeroen_240.jpg" title=" Jeroen van der Sommen" alt="Jeroen van der Sommen, co-founder " /></div>
        ...
        <li class="staffAsset partnership" id="frodo">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/frodoprofilepicx240.jpg" title="Frodo van Oostveen" alt="Frodo van Oostveen, programme manager" /></div>
        ...
        <li class="staffAsset partnership" id="phylis">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/phylis2_240b.jpg" title="Phylis Gichuru Webi" alt="Phylis Gichuru Webi, partnerships assistant, East Africa hub " /></div>
        ...
        <li class="staffAsset partnership" id="francis">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/francis240.png" title="Francis Warui" alt="Francis Warui, partnership assistant, East Africa hub" /></div>
    ...
    <div id="communicationGroup">
      ...
      <ul class="staff floats-in">
        <li class="staffAsset management communication" id="markC">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/charmerx2240.jpg" title="Mark Charmer" alt="Mark Charmer, co-founder and communications director" /></div>
        ...
        <li class="staffAsset communication" id="jo">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/jocrop240.png" title="Jo Pratt" alt=" Jo Pratt, communications manager " /></div>
        ...
        <li class="staffAsset communication" id="emily">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/Emily240.jpg" title="Emily Armanetti" alt="Emily Armanetti, communications manager" /></div>
          <div class="staffName"><a href="#"> Emily Armanetti</a></div>
          <p class="staffTitle">Communications manager</p>
          <small>Click for more details.</small></li>
        <li class="staffAsset communication" id="linda">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/Linda240.jpg" title="Linda Leunissen, illustrator and graphic designer" alt="Linda Leunissen, illustrator and graphic designer" /></div>
    ...
    <div id="engineeringGroup">
      ...
      <ul class="staff floats-in">
        ...
        <li class="staffAsset engineering" id="paul">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/Paul240.jpg" title="Paul Burt: web programmer" alt="Paul Burt: web programmer" /></div>
          <div class="staffName"><a href="#">Paul Burt</a></div>
          <p class="staffTitle">Web programmer</p>
          <small>Click for more details.</small></li>
        <li class="staffAsset engineering" id="oli">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/oligl.png" title="Oliver Galloway-Lunn" alt="Oliver Galloway-Lunn, Developer" /></div>
        ...
        <li class="staffAsset engineering" id="loic">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/loic240.jpg" title="Loïc Sans" alt="Loïc Sans, designer and front-end developer" /></div>
        ...
        <li class="staffAsset engineering" id="gabriel">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/gabriel_240.jpg" title="Gabriel von Heijne" alt="Gabriel von Heijne, co-founder and developer" /></div>
        ...
        <li class="staffAsset engineering" id="daniel">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/daniel240v2.png" title="Daniel Karlsson" alt="Daniel Karlsson, web developer" /></div>
        ...
        <li class="staffAsset engineering" id="adrian">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/adrian240b.jpg" title="Adrian Collier" alt="Adrian Collier, product manager, Akvo RSR" /></div>
        ...
        <li class="staffAsset engineering" id="stellan">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/stellan240.jpg" title="Stellan Lagerström" alt="Stellan Lagerström, developer" /></div>
          <div class="staffName"><a href="#">Stellan Lagerström</a></div>
          <p class="staffTitle">Developer</p>
          <small>Click for more details.</small></li>
        <li class="staffAsset engineering" id="ivan">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/ivan.png" title="Iván Perdomo" alt="Iván Perdomo, developer" /></div>
          <div class="staffName"><a href="#">Iván Perdomo</a></div>
          <p class="staffTitle">Developer</p>
          <small>Click for more details.</small></li>
        <li class="staffAsset engineering" id="lynn">
          <div class="imgWrapper"><img src="<?php bloginfo('template_directory'); ?>/images/staff/lynn240.png" title="Lynn Greenwood" alt="Lynn Greenwood, internal IT manager and assistant to Thomas" /></div>
