...
<nav class="anchorNav wrapper">
  ...
  <div class="mShownCollapse"><a></a></div>
    <ul>
      ...
      <li><a href="#rsrInFive">RSR in five points</a></li>
  ...
  <section class="inFivePoints" id="rsrInFive">
    ...
    <ul class="wrapper">
      ...
      <li class="pointFour floats-in">
        <h3> <span>04</span>
          <?php the_field('rsr_point_four_h3'); ?>
        </h3>
      ...
      <li class="pointFive floats-in">
        ...
        <h3> <span>05</span>
          <?php the_field('rsr_point_five_h3'); ?>
        </h3>
        <img src="<?php the_field('rsr_point_five_img'); ?>" />
        <div class="textFivePoints">
          <p>
            <?php the_field('rsr_point_five_text'); ?>
          </p>
        </div>
      </li>
    </ul>
